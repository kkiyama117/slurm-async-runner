...
class TssrunJobHandle:
    ...
    # Phase 3 P5: ``jobid`` / ``uuid`` / ``is_running`` / ``is_finished`` /
    # ``exit_code`` are sync — they read lock-free off the local
    # watch::Receiver and have no tokio work to wait on. The ``_async``
    # variants preserve the pre-P5 async contract for callers that wired
    # an ``await`` against the previous shape.
    @property
    def jobid(self) -> builtins.int | None: ...
    @property
    def jobid_async(self) -> Awaitable[builtins.int | None]: ...
    @property
    ...
    @property
    def uuid_async(self) -> Awaitable[builtins.str]: ...
    @property
    ...
    def is_running_async(self) -> Awaitable[builtins.bool]: ...
    def is_finished(self) -> builtins.bool: ...
    def is_finished_async(self) -> Awaitable[builtins.bool]: ...
    def exit_code(self) -> builtins.int | None: ...
    def exit_code_async(self) -> Awaitable[builtins.int | None]: ...
