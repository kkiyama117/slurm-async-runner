...
//!
//! Two sub-modules are exposed at `slurm_async_runner._slurm_async_runner_core.entities.slurm`:
//!
//! - [`sbatch_options`] — sbatch directive primitives and the
//!   [`sbatch_options::config::PySlurmJobConfig`] envelope. Available
//!   at `slurm_async_runner._slurm_async_runner_core.entities.slurm.sbatch_options`.
...
pub(crate) mod inner_module {
    ...
    const PYTHON_MODULE_NAME: &str = "slurm_async_runner._slurm_async_runner_core.entities.slurm";
